		...
		<div class="panel panel-body panel-default">
			<div class="row info">
				...
				<div class="col-md-9 url-info">
					<h2>
						<a href="<?php echo $url->url ?>" rel="nofollow"><?php echo $url->meta_title ?></a>
					...
					<div class="row">
						...
						<div class="col-sm-4 text-center">
							<p>
								<i class="glyphicon glyphicon-link"></i> <?php echo $this->config["url"] ?>/<?php echo $url->alias.$url->custom ?> <a href="#copy" class="copy inline-copy hidden-xs"  data-clipboard-text="<?php echo $this->config["url"] ?>/<?php echo $url->alias.$url->custom ?>"><?php echo e("Copy")?></a>								
							</p>
							<p>
								<i class="glyphicon glyphicon-qrcode"></i> <?php echo $this->config["url"] ?>/<?php echo $url->alias.$url->custom ?>/qr <a href="#copy" class="copy inline-copy hidden-xs"  data-clipboard-text="<?php echo $this->config["url"] ?>/<?php echo $url->alias.$url->custom ?>/qr"><?php echo e("Copy")?></a>								
							</p>	
